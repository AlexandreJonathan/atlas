...
- **Atlas Intelligence**: UI → `AtlasIntelligenceService` → `AtlasAIProvider` (`MockAtlasAIProvider` ativo; stub `OpenAIProvider`). Insights + feed; sem LLM nesta fase. Ver `roadmap/atlas-intelligence.md`.
