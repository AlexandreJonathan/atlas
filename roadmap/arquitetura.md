...
│   ├── config.toml
│   ├── functions/
│   │   └── atlas-ai-chat/     # proxy OpenAI (Sprint 17) — secret OPENAI_API_KEY
│   └── migrations/
